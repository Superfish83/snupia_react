...
export default function About() {
  ...
  return (
    <div style={{padding: 30}}>
      <h1 className='title'><GiMusicalScore /> 동아리 소개 </h1>
      ...
      <p>
        ...
        2026년까지 총 35회의 정기연주회를 성공적으로 개최했습니다.
      </p>

      <div className="imgbox">
      {/* 최신 정기연주회 게시글에서 포스터 '이미지 링크 복사' 후 붙여넣기 하여 업데이트해 주세요.
          (251225 김연준) */}
      <img  src="https://snupia.kr/data/file/history/thumb-23002670b75ed4860eca08ad145c6805_7nOk0vGH_1bbacc4e4eca4237801c0dda6803102b5b638d5d_600x848.jpg"
            alt="concert"></img>
      <img  src="https://snupia.kr/data/file/history/thumb-72079c03d9876bfb80321749475cd157_nKg3U8HZ_e3814ff9df68466d7ccf674312498046b37f3532_600x848.jpg"
            alt="concert"></img>
      </div>
      <div className="imgcaption">2026년 SNUPia 제35회 정기연주회 포스터</div>

      <p>
        SNUPia의 동아리방은 <b>서울대학교 학생회관(63동) 427호</b>에 위치해 있습니다.
      ...
      <GiMusicalScore /> 동아리방 및 소장 자료 소개</a>
      </div>
      ...
      <br/>
      <h2 className='title'><GiMusicalScore /> 멘토링 활동</h2>
      <p>
      ...
      <br/>
      <h2 className='title'><GiMusicalScore /> 친목 활동</h2>
      <p>
      ...
      <br/>
      <h2 className='title'><GiMusicalScore /> 대외 교류 활동</h2>
      <p>
      ...
      <img  src="https://snupia.kr/data/editor/2511/thumb-20251110214700_20d40af4043ba35e8201a9c544cdc617_0ujd_600x800.png"
            alt="cooperation"></img>
      <img  src="https://snupia.kr/data/editor/2601/thumb-20260118165250_b4c6a3ba338317bcc8ef9a4b19ec8331_oyft_600x751.jpg"
            alt="cooperation"></img>
      </div>
      ...
      <br/>
      <h2 className='title'><GiMusicalScore /> 가입 안내</h2>
      <p>
